...
title: about
permalink: /
description: Researcher in large multimodal models and video understanding. PhD, NUS.
...
profile:
  ...
  address: |
    <ul class="author-links">
      ...
      <li><a href="mailto:thong.nguyen@u.nus.edu"><i class="fas fa-envelope"></i> Email</a></li>
      <li><a href="https://www.linkedin.com/in/thongnguyen5999/"><i class="fab fa-linkedin"></i> LinkedIn</a></li>
      <li><a href="https://github.com/nguyentthong"><i class="fab fa-github"></i> GitHub</a></li>
      <li><a href="https://scholar.google.com/citations?user=C2zb0lkAAAAJ"><i class="fas fa-graduation-cap"></i> Google Scholar</a></li>
    </ul>
    <p class="photo-credit-line"><span style="font-weight: 700!important">Photo credit</span>: <span style="font-family: 'Lucida Console', monospace"><a href="https://www.instagram.com/abbymyth/" style="color:var(--global-theme-color)">abbymyth<i class="material-icons" style="font-size:15px;color:#fec44f">wb_sunny</i></a></span></p>

news: true  # includes a list of news items
selected_papers: true # renders publications grouped by year (see _includes/selected_papers.html)
years: [2026, 2025, 2024, 2023, 2022, 2021]
social: false  # bottom social icons hidden; contact links are in the sticky sidebar
---
I am a researcher working at the intersection of NLP, computer vision, and multimodal learning, with a focus on large multimodal models and video understanding. I received my PhD from the National University of Singapore in September 2025, advised by Professor <a href="https://www.comp.nus.edu.sg/~ngsk/">See-Kiong Ng</a> and Professor <a href="https://tuanluu.github.io/">Anh-Tuan Luu</a>. My research focuses on building and understanding multimodal models for language, vision, and video.
